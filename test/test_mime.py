...
class TestService(unittest.TestCase):
    ...
    def test_json_convert(self):
        ...
        self.assertEqual(self.converter.json_convert(TestObject(name='hello', id=1), sort_keys=True), '{"id": 1, "name": "hello"}')
    ...
    def test_json_revert(self):
        ...
        self.assertEqual(self.converter.json_revert('{"name": "hello", "id": 1}','TestObject'), TestObject(name='hello', id=1))
    ...
    def test_xml_convert(self):
        ...
        self.assertEqual(self.converter.xml_convert(TestObject(name='hello', id=1)), '<TestObject><id type="int">1</id><name>hello</name></TestObject>')
    ...
    def test_xml_revert(self):
        ...
        self.assertEqual(self.converter.xml_revert('<TestObject><name>hello</name><id type="int">1</id></TestObject>','TestObject'),TestObject(name='hello', id=1))

    def test_csv_convert(self):
        self.assertEqual(self.converter.csv_convert([{'a':1,'b':2},{'a':3,'b':4}]), 'a,b\n1,2\n3,4\n')
        self.assertEqual(self.converter.csv_convert([TestObject(name='a',id=1),TestObject(name='b',id=2)]), 'id,name\n1,a\n2,b\n')

    def test_csv_revert(self):
        self.assertEqual(self.converter.csv_revert('a,b\n1,2\n3,4', 'dict'), [{'a':'1','b':'2'},{'a':'3','b':'4'}])
        self.assertEqual(self.converter.csv_revert('name,id\na,1\nb,2', 'TestObject'), [TestObject(name='a',id=1),TestObject(name='b',id=2)])
